...
![04-hash](C:\Users\user\Desktop\Computer\webhacking.kr-master\pic\04-hash.png)
...
세션값은 10000000~99999999사이의 임의의 값 + salt_for_you, 출력된 값은  이를 500번 sha1 인코딩 한 값이다. 그러나 sha1은 단방향 암호화 알고리즘으로 500번이나 디코딩할 수 없다. 브루트 포스 공격도 불가능하므로 파이썬으로 레인보우 테이블을 만들어주면 될듯하다.

__exploit__: [old-04.py](code/old-04.py)

![image-20200419200006285](C:\Users\user\AppData\Roaming\Typora\typora-user-images\image-20200419200006285.png)
...
![](C:\Users\user\Desktop\Computer\webhacking.kr-master\pic\05-login.PNG)

/mem으로 접속하면 접속이 거부되었던 join.php에 접근할 수 있게 된다.

![](C:\Users\user\Desktop\Computer\webhacking.kr-master\pic\05-mem.png)
...
코드를 조금예쁘게 정리해 보자. https://beautifier.io/ js beautifulier와 console 이용해서 해석해보면 다음과 같다.
...
![05-join](C:\Users\user\Desktop\Computer\webhacking.kr-master\pic\05-join.png)

admin으로 로그인해야 하는데 이는 이미 있는 id라고 나온다. max length를 20보다 크게 바꿔줘 공백 여려개와 아무 문자나 넣어주면 자동으로 admin만 잘리게 된다.

![](C:\Users\user\Desktop\Computer\webhacking.kr-master\pwned\old-05.png)
